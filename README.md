...
4. 연결 완료 표시가 나타나면 **채팅 모아서 뽑기**를 누릅니다.
5. 팝업 모달에서 30초 동안 수집되는 채팅을 실시간으로 확인합니다. 같은 시청자가 여러 번 채팅하면 마지막 채팅 하나만 후보로 남습니다.
6. 30초가 끝나면 룰렛이 자동으로 돌고 당첨 결과를 보여 줍니다. 이후 **다시 뽑기**를 누르면 모아 둔 후보 안에서 즉시 재추첨합니다.
