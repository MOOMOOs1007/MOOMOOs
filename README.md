...
5. 30초 동안 들어오는 채팅은 오른쪽 **모인 채팅** 목록에 실시간으로 표시됩니다. 같은 시청자가 여러 번 채팅하면 마지막 채팅 하나만 후보로 남습니다.
...
설정 영역에서 새 항목을 직접 추가할 수 있습니다. 각 항목의 **직접 답변 1개** 입력란에 내용을 적어 두면 해당 항목의 채팅 수집을 시작할 때 후보 목록에 자동으로 포함됩니다. 전체 초기화를 해도 항목 설정과 직접 답변은 유지됩니다.
