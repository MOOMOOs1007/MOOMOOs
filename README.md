...
정적 HTML/CSS/JS 화면과 Vercel Function을 함께 배포합니다. 사용자가 SOOP 방송국 ID 또는 라이브 주소를 입력하고 **채팅 모아서 뽑기**를 누르면, 서버가 공개 방송의 채팅방에 입장한 시점부터 30초 동안 일반 채팅을 전달합니다.
...
3. **채팅 모아서 뽑기**를 누릅니다.
4. 팝업 모달에서 30초 동안 수집되는 채팅을 실시간으로 확인합니다. 같은 시청자가 여러 번 채팅하면 마지막 채팅 하나만 후보로 남습니다.
5. 30초가 끝나면 룰렛이 자동으로 돌고 당첨 결과를 보여 줍니다. 이후 **다시 뽑기**를 누르면 모아 둔 후보 안에서 즉시 재추첨합니다.
